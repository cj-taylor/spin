...
/*
ProjectControllerApiService Create a project
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body body

@return interface{}
*/
func (a *ProjectControllerApiService) CreateProjectUsingPOST(ctx context.Context, body interface{}) (interface{}, *http.Response, error) {
	var (
...
/*
ProjectControllerApiService Update an existing project
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id id
...
@return interface{}
*/
func (a *ProjectControllerApiService) UpdateProjectUsingPUT(ctx context.Context, id string, project interface{}) (interface{}, *http.Response, error) {
	var (
